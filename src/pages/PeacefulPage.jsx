...
const PeacefulPage = () => {
  ...
  return (
    <div className="flex-1 flex flex-col min-h-0 bg-[#FDFBF7] font-quicksand">
      {/* Header */}
      <header className="w-full px-6 py-5 flex items-center justify-between bg-white/80 backdrop-blur-md shrink-0 z-10 border-b border-surface-container-highest">
      ...
      {/* Main Content */}
      <main className="flex-1 min-h-0 overflow-y-auto px-6 pb-10 no-scrollbar">
